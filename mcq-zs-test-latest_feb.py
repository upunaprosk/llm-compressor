...
def main(args):
    ...
    use_qlora = False
    if args.adapter:
        if "qlora" in (args.adapter_type or "").lower():
            use_qlora = True
        else:
            use_lora = True
...
if __name__ == '__main__':
    ...
    parser.add_argument('--adapter', type=str, help="Path to the optional LoRA or QLoRA adapter")
    parser.add_argument('--adapter_type', type=str, help="Adapter type: LoRA or QLoRA")
